...
//        }
    ...
    private static void saveResults(int from, int testIndex) {
        ...
        Printer.saveToExcel("Test2-Results-New-Metric-from-"+from+"-to-"+testIndex, workflowVersions, goalServicesNum, precisions, recalls, fscores, steps, links, hits, recommendedStructure, workflowStructures, recommendedGraphServices);
    }
